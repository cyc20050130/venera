...
extension TagsTranslation on String {
  ...
  static Future<void> readData() async {
    ...
    final nextData = <String, Map<String, String>>{};
    if (decoded is Map) {
      for (final entry in decoded.entries) {
        ...
        for (final tagEntry in value.entries) {
          final tag = tagEntry.key;
          final translation = tagEntry.value;
          if (tag is String && translation is String) {
            namespace[tag] = translation;
          }
        }
        nextData[key] = namespace;
      }
    }
    _data
      ..clear()
